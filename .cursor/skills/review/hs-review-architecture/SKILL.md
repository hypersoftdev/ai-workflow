---
name: hs-review-architecture
description: Hypersoft Cursor Skill: Review Android changes against Clean Architecture, MVI, module boundaries, and project rules. Use when reviewing PRs, refactors, or asking if code follows architecture standards. Prefer hs-review-complete for a full multi-check pass.
---
...
### Threading / ANR (`06-coroutines-flow`, `hs-review-performance`)
