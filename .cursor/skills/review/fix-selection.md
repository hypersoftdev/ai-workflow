...
Used by `hs-review-architecture`, `hs-review-performance`, `hs-review-security`, and `hs-review-complete`.
...
5. For `hs-review-complete`, keep **one** number sequence across Architecture + Performance + Security (do not restart at 1 per section).
