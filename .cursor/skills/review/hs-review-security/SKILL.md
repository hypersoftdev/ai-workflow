---
name: hs-review-security
description: Hypersoft Cursor Skill: Review Android code for secrets, exported components, permissions, logging leaks, and R8 keep rules. Use when security review, release prep, or auditing sensitive data handling. Prefer hs-review-complete for a full multi-check pass.
---
