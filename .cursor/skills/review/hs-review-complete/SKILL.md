---
name: hs-review-complete
description: Hypersoft Cursor Skill: Run full project/PR review — architecture, performance, and security — into one Pass/Fail report. Use when asking for complete review, review-*, or pre-merge quality gate.
---
...
1. **`hs-review-architecture`**
2. **`hs-review-performance`**
3. **`hs-review-security`**
