---
name: hs-build-release-apk
description: Hypersoft Cursor Skill: Configure release signing, find an attached Android device, build the release APK, install it, and launch the app. Use when the user asks to build release apk, install release, or /hs-build-release-apk.
---
