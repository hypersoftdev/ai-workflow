---
name: hs-add-admob-native
description: Hypersoft Cursor Skill: Add an AdMob native placement to an existing :gmaAds app (AdKey, AdConfig, ad_ids, RC, container, load/show/destroy). Use when adding native ads, or /hs-add-admob-native. If ads were never wired, use hs-implement-admob-ads first.
---
