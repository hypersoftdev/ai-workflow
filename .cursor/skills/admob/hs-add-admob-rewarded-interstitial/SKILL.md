---
name: hs-add-admob-rewarded-interstitial
description: Hypersoft Cursor Skill: Add an AdMob rewarded interstitial placement to an existing :gmaAds app (AdKey, AdConfig, ad_ids, RC, load/show with granted). Use when adding rewarded interstitial ads, or /hs-add-admob-rewarded-interstitial. If ads were never wired, use hs-implement-admob-ads first.
---
