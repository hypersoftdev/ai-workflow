---
name: hs-add-admob-interstitial
description: Hypersoft Cursor Skill: Add an AdMob interstitial placement to an existing :gmaAds app (AdKey, AdConfig, ad_ids, RC, load/show). Use when adding interstitial ads, or /hs-add-admob-interstitial. If ads were never wired, use hs-implement-admob-ads first.
---
