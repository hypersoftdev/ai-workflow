...
For first-time full-app events → `hs-implement-firebase-events`.

## Entry

| App state                                                      | Action                                                                                                                               |
|----------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| No `EventsProvider` (or equivalent) and no `postFirebaseEvent` | Stop → **`hs-implement-firebase-events`**                                                                                               |
...
- [ ] No new Analytics library unless poster was missing (then stop and send user to `hs-implement-firebase-events`)

## Do not

- Full-app sweep (that is `hs-implement-firebase-events`)
- Remote Config (`hs-add-firebase-remote-config`)
