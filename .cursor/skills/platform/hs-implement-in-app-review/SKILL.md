---
name: hs-implement-in-app-review
description: Hypersoft Cursor Skill: Add Google Play In-App Review with InAppReviewManager in core-ui. Use when the user asks to add in-app review, Play Core review, review-ktx, rate flow API, or /hs-implement-in-app-review.
---

# Implement In-App Review

Follow `.cursor/rules/08-gradle.mdc`, `13-libraries-stack.mdc`, `16-logging.mdc`, `27-in-app-review.mdc`.  
...
1. Add to `libs.versions.toml` under **Google** section (`hs-gradle-organize` headers)
