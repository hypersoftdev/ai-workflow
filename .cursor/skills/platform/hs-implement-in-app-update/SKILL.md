---
name: hs-implement-in-app-update
description: Hypersoft Cursor Skill: Add Google Play In-App Updates (Immediate/Flexible) with InAppUpdateManager in core-ui. Use when the user asks to add in-app update, Play Core app update, flexible/immediate update, or /hs-implement-in-app-update.
---
