---
name: hsc-build-release-apk
description: Hypersoft Claude Skill: Configure release signing, find an attached Android device, build the release APK, install it, and launch the app. Use when the user asks to build release apk, install release, or /hsc-build-release-apk.
---
