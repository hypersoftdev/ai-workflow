...
Used by `hsc-review-architecture`, `hsc-review-performance`, `hsc-review-security`, and `hsc-review-complete`.
...
5. For `hsc-review-complete`, keep **one** number sequence across Architecture + Performance + Security (do not restart at 1 per section).
