...
First-time RC stack → **`hsc-implement-firebase-remote-config`**.
...
| App state                                                                 | Action |
|---------------------------------------------------------------------------|--------|
| No RC DataSource / repository **and** no RC cache properties on prefs     | Stop → **`hsc-implement-firebase-remote-config`** |
...
- First-time RC stack (`hsc-implement-firebase-remote-config`)
- Analytics / `EventsProvider` (`hsc-add-firebase-events`)
