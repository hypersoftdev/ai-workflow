---
name: hsc-build-debug-apk
description: Hypersoft Claude Skill: Find an attached Android device, build the debug APK, install it, and launch the app. Use when the user asks to build debug apk, install debug, run on device, or /hsc-build-debug-apk.
---
