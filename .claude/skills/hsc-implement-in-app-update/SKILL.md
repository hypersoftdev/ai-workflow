---
name: hsc-implement-in-app-update
description: Hypersoft Claude Skill: Add Google Play In-App Updates (Immediate/Flexible) with InAppUpdateManager in core-ui. Use when the user asks to add in-app update, Play Core app update, flexible/immediate update, or /hsc-implement-in-app-update.
---
...
1. Add to `libs.versions.toml` under **Google** section (`hsc-gradle-organize` headers)
