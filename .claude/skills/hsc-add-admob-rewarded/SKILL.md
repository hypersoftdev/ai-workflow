---
name: hsc-add-admob-rewarded
description: Hypersoft Claude Skill: Add an AdMob rewarded placement to an existing :gmaAds app (AdKey, AdConfig, ad_ids, RC, load/show with granted). Use when adding rewarded ads, or /hsc-add-admob-rewarded. If ads were never wired, use hsc-implement-admob-ads first.
---
