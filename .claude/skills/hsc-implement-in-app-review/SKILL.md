---
name: hsc-implement-in-app-review
description: Hypersoft Claude Skill: Add Google Play In-App Review with InAppReviewManager in core-ui. Use when the user asks to add in-app review, Play Core review, review-ktx, rate flow API, or /hsc-implement-in-app-review.
---
