---
name: hsc-review-complete
description: Hypersoft Claude Skill: Run full project/PR review — architecture, performance, and security — into one Pass/Fail report. Use when asking for complete review, review-*, or pre-merge quality gate.
---
...
1. **`hsc-review-architecture`**
2. **`hsc-review-performance`**
3. **`hsc-review-security`**
