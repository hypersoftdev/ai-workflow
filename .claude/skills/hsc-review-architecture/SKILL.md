---
name: hsc-review-architecture
description: Hypersoft Claude Skill: Review Android changes against Clean Architecture, MVI, module boundaries, and project rules. Use when reviewing PRs, refactors, or asking if code follows architecture standards. Prefer hsc-review-complete for a full multi-check pass.
---
...
### Threading / ANR (`06-coroutines-flow`, `hsc-review-performance`)
