...
Used by `hsc-implement-firebase-events` and `hsc-add-firebase-events`. Follow `.claude/rules/22-platform-firebase.md`, `12-naming-conventions.md`, `16-logging.md`.
...
Speak-Translate / `hsc-setup-new-project` shape (`PlatformFirebase` in `:core-platform`):
